    ...
    if (c === '<' || c === '>' || c === ',') {
      if (keyword.length > 0) {
        if (exports.isUserDefinedType(dakota, keyword)) {
          // validator += exports.dbValidator(dakota, keyword);
        }
        else {
...
exports.castValue = function(dakota, value) {
  ...
  else if ((value instanceof nmCassandraTypes.Uuid) || (value instanceof nmCassandraTypes.TimeUuid)) {
