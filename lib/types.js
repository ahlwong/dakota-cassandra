...
// expects: (dakota{Dakota}, type{String}, excludeFrozen{Boolean}?)
// returns: dbValidator{String}
exports.dbValidator = function(dakota, type, excludeFrozen) {
  var validator = '';
  var keyword = '';
  var frozen = {};
  var level = 0;
        ...
        if (keyword.length > 0) {
          if (exports.isUserDefinedType(dakota, keyword)) {
            ...
            if (!excludeFrozen && c === '<' && frozen[level - 1] && frozen[level - 1] > 0) {
              frozen[level - 1] -= 1;
              validator += exports.KEYWORDS['frozen'].dbValidator + '<';
            }
