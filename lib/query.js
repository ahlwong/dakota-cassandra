...
Query.prototype.where = function(arg1, arg2) {
  ...
  if (!lHelpers.isHash(arg1)) {
    ...
    nm_.each(arg1, function(conditions, column) {
      ...
      // normalize value
      if (nm_.isString(conditions) || nm_.isNull(conditions)) {
...
Query.prototype.save = function(callback, options) {
  ...
  this._instance._save(callback, this);
};
...
Query.prototype.delete = function(callback) {
  ...
  this._instance._delete(callback, this);
};
