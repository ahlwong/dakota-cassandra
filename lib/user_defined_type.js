...
// expects: (dakota{Dakota}, name{String}, fields{Fields}, options{Object}?)
// returns: undefined
function UserDefinedType(dakota, name, fields, options) {
  ...
  else if (!lHelpers.isHash(fields)) {
...
// expects: (column{String}, newName{String}, function(err{Error}, result)) or ({ column{String}: newName{String}, ... }, function(err{Error}, result))
// returns: undefined
