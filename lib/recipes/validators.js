...
exports.validateMultiple = function(validators) {
  ...
  return {
    validator: function(value, instance) {
      ...
      var failedValidators = nm_.reduce(validators, function(memo, validator) {
        if (!validator.validator.call(self, value, instance)) {
          memo.push(validator);
        }
        return memo;
      }, []);
      scope.failedValidators = failedValidators;
    ...
    message: function(displayName) {
      ...
      return nm_.map(scope.failedValidators, function(validator) { return validator.message.call(self, displayName); });
    }
  }
};