...
// expects: (field{String}, displayName{String}, validator{Validator}) or (field{String}, displayName{String}, [validator{Validator}, ...]) or (field{String}, validator{Validator}) or (field{String}, [validator{Validator}, ...])
exports.validateObjectFields = function(field, displayName, validators) {
  
  // normalize
  if (!nm_.isString(displayName)) {
  ...
  return {
    ...
    message: function(parentDisplayName) { return validateMultiple.message(displayName); }
  }
};
