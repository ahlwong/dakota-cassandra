...
Model.prototype.validate = function(options) {
  ...
  if (!options.callback || !(options.callback.skipAll || options.callback.skipBeforeValidate)) {
  ...
  if (!options.callback || !(options.callback.skipAll || options.callback.skipAfterValidate)) {
...
Model.prototype._save = function(callback, query, options) {
  ...
  if (!this._exists) {
    if (!options.callback || !(options.callback.skipAll || options.callback.skipBeforeCreate)) {
      runCallbacks.call(this, 'beforeCreate');
    }
  }
  
  // beforeSave callbacks
  if (!options.callback || !(options.callback.skipAll || options.callback.skipBeforeSave)) {
  ...
  function wrappedCallback(err, result) {
    if (err) {
      ...
      if (!self._exists) {
        if (!options.callback || !(options.callback.skipAll || options.callback.skipAfterCreate)) {
          runCallbacks.call(self, 'afterCreate');
        }
      }
      
      // afterSave callbacks
      if (!options.callback || !(options.callback.skipAll || options.callback.skipAfterSave)) {
...
Model.prototype._delete = function(callback, query, options) {
  ...
  if (!options.callback || !(options.callback.skipAll || options.callback.skipBeforeDelete)) {
  ...
  query.action('delete').where(primaryKeyConditions.call(this)).execute(function(err, result) {
    if (err) {
      ...
      if (!options.callback || !(options.callback.skipAll || options.callback.skipAfterDelete)) {
